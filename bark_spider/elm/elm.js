...
Elm.BarkSpider = Elm.BarkSpider || {};
Elm.BarkSpider.make = function (_elm) {
   "use strict";
   _elm.BarkSpider = _elm.BarkSpider || {};
   if (_elm.BarkSpider.values) return _elm.BarkSpider.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var script = function (url) {    return A3($Html.node,"script",_U.list([$Html$Attributes.src(url)]),_U.list([]));};
   var stylesheet = function (url) {    return A3($Html.node,"link",_U.list([$Html$Attributes.rel("stylesheet"),$Html$Attributes.href(url)]),_U.list([]));};
   var view = F2(function (address,model) {
      return $Bootstrap$Html.container_(_U.list([stylesheet("https://maxcdn.bootstrapcdn.com/bootstrap/3.3.5/css/bootstrap.min.css")
                                                ...
                                                ,$Bootstrap$Html.row_(_U.list([A4($Bootstrap$Html.colMd_,
                                                                              2,
                                                                              2,
                                                                              2,
                                                                              _U.list([$Html.text("llamas"),$Html.text("yaks")]))
                                                                              ,A4($Bootstrap$Html.colMd_,
                                                                              10,
                                                                              10,
                                                                              10,
                                                                              _U.list([$Html.text("emus")
                                                                                      ,$Html.text("platypuses...platypi? Not sure.")]))]))]));
   });
   var Nothing = {ctor: "Nothing"};
   var Model = F2(function (a,b) {    return {simulations: a,error_messages: b};});
   var Simulation = F3(function (a,b,c) {    return {name: a,included: b,parameters: c};});
   var Parameters = F3(function (a,b,c) {    return {assimilation_delay: a,training_overhead_proportion: b,interventions: c};});
   return _elm.BarkSpider.values = {_op: _op
